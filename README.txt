...
[FOR INTENTED USE, EXECUTE ON A WINDOWS OS; MAC OS IS FINIKY WITH CONTROLS; NOT TESTED ON LINUX; potentially could run if python is installed however, GUI controls have not been tested to see if they work properly]
...
EXIT INSTRUCTIONS:
1] When ready to close program you can click the X button on the window bar or conveniently on both the simulation tab and the management tab there is a close button in the bottom left corner
...
[Limitations]
	...
	- Current version is a simulation tool, not a live security monitoring system
